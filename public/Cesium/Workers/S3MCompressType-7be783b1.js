 ...
 */
define(['exports', './when-8d13db60', './Check-70bec281', './Cartographic-f2a06374', './Cartesian4-5af5bb24', './Cartesian2-16a61632', './BoundingSphere-356f49c6', './RuntimeError-ba10bc3e', './WebGLConstants-4c11ee5f', './ComponentDatatype-5862616f', './PrimitiveType-97893bc7', './IndexDatatype-9435b55f', './BoundingRectangle-5c75c80b'], function (exports, when, Check, Cartographic, Cartesian4, Cartesian2, BoundingSphere, RuntimeError, WebGLConstants, ComponentDatatype, PrimitiveType, IndexDatatype, BoundingRectangle) { 'use strict';
    ...
    S3MEdgeProcessor.RegularInstanceStride = 10;//每个实例的步进长度
    ...
    S3MEdgeProcessor.createRegularEdgeAttributes = function(context, regular){
        ...
        var stride = S3MEdgeProcessor.RegularInstanceStride;//3 + 3 + 3 + 1 pos0 pos1 facenormal0 batchID
        ...
        attributeLocations['batchId'] = attIndex++;
        attributes.push({
            index : attributeLocations['batchId'],
            vertexBuffer : instanceBuffer,
